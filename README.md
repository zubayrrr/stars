...
- [darthcloud/BlueRetro](https://github.com/darthcloud/BlueRetro) - Multiplayer Bluetooth controllers adapter for retro video game consoles & computers
...
- [baduhai/Koi](https://github.com/baduhai/Koi) - Koi - Theme scheduling for the KDE Plasma Desktop
...
- [getAlby/zap-button](https://github.com/getAlby/zap-button) - Bringing zaps truly out of nostr!
...
- [nilsreichardt/AnkiGPT](https://github.com/nilsreichardt/AnkiGPT) - Turn lecture slides into flashcards and export them to Anki. Uses GPT-4 by OpenAI. AnkiGPT already generated 2,978,549 flashcards.
...
- [ms1963/TechnicalDebtRecords](https://github.com/ms1963/TechnicalDebtRecords) - Tool and documentation for systematically using Technical Debt Records
...
- [speakeasy-api/openapi](https://github.com/speakeasy-api/openapi) - A set of packages and tools for working with OpenAPI, Arazzo and Overlay Specification documents.
...
- [andrewarrow/feedback](https://github.com/andrewarrow/feedback) - golang webapp framework (rails inspired) with WASM, Effortless Migrations, Simple SQL that's NOT gorm, and Ultimate Routing Control
...
- [quaintdev/pinotes](https://github.com/quaintdev/pinotes) - Take notes from address bar
...
- [Happy-Technologies-LLC/mcp-servicenow-nodejs](https://github.com/Happy-Technologies-LLC/mcp-servicenow-nodejs) - ServiceNow MCP Server v2.1 - Multi-Instance Intelligent Architecture
...
- [readium/css](https://github.com/readium/css) - 🌈 A set of reference stylesheets for EPUB Reading Systems, starting with Readium Mobile
...
- [Olanetsoft/awesome-article-collection](https://github.com/Olanetsoft/awesome-article-collection) - Curated articles by writers, both technical and non-technical. This was made specifically to encourage content creators to discover their strengths and consistently produce quality articles. You are w
- [lassebomh/box-breathing](https://github.com/lassebomh/box-breathing) - Box Breathing Technique: A visual animation to help with calmness, mindfulness, stress and anxiety
- [tigattack/tigs-hugo-utils](https://github.com/tigattack/tigs-hugo-utils) - Shortcodes and partials for Hugo Blowfish theme.
- [marconoris/Obsidian-Publish-stuff](https://github.com/marconoris/Obsidian-Publish-stuff) - 
...
- [IppSec/ippsec.github.io](https://github.com/IppSec/ippsec.github.io) - 
...
- [Hunter-Plus/AmericanAccentTrainerWithGoogle](https://github.com/Hunter-Plus/AmericanAccentTrainerWithGoogle) - A simple tool based on google search and Sounds American Channel on YouTube to perfect America accent
...
- [milahu/alchi](https://github.com/milahu/alchi) - compatibility chart for personality types
- [dev-alihasan/Store-Web-page](https://github.com/dev-alihasan/Store-Web-page) - It is fully responsive and I designed it using html, css, javascript - alihasan
- [dev-alihasan/password-generator-](https://github.com/dev-alihasan/password-generator-) - password generator creates random passwords
...
- [charliie-dev/Logseq-Hugo-Template](https://github.com/charliie-dev/Logseq-Hugo-Template) - This is a HUGO website template for Logseq users who wants their published posts to look more like a personal website, using GitHub Pages to host the website and logseq-schrodinger to export your Logs
...
- [ad-si/adriansieber-com](https://github.com/ad-si/adriansieber-com) - My website & blog with articles about coding, tech, functional programming, …
...
- [breck7/breckyunits.com](https://github.com/breck7/breckyunits.com) - Breck's Blog
...
- [consoledotdev/home](https://github.com/consoledotdev/home) - A free weekly devtools newsletter.
...
- [sequoia-hope/rpi-cm4-switch-board](https://github.com/sequoia-hope/rpi-cm4-switch-board) - A  Raspberry Pi (RPi) Compute Module 4 (CM4) Carrier Board with integrated gigabit switch
...
- [asqrzk/jsonresume-theme-dev-ats](https://github.com/asqrzk/jsonresume-theme-dev-ats) - Developer ATS friendly JSONResume theme
...
- [osdev0/wiki](https://github.com/osdev0/wiki) - Modern OS Development wiki.
...
- [Bolls-Bible/bain](https://github.com/Bolls-Bible/bain) - A web app for reading the Bible with full emphasis on the God`s Word only. Sola scriptura
...
- [popeen/Booksonic-App](https://github.com/popeen/Booksonic-App) - The Booksonic Android App, based on DSub. - OBS: The code here might not be ready for release. Feel free to compile it yourself but if so I recommend searching for the latest commit with the descripti
- [popeen/Booksonic-Air](https://github.com/popeen/Booksonic-Air) - A new Booksonic server based on Airsonic. - OBS: The code here might not be ready for release. Feel free to compile it yourself but if so I recommend searching for the latest commit with the descripti
...
- [BenBurum/ThoughtsForGary](https://github.com/BenBurum/ThoughtsForGary) - Random Busey, Random Nietzche.
- [VirtCode/SmartMouse](https://github.com/VirtCode/SmartMouse) - use your smartphone as a normal computer mouse
- [googlesamples/android-testdpc](https://github.com/googlesamples/android-testdpc) - Test DPC is a sample device policy controller for use with Android Enterprise. It gives developers the ability to see how their app will behave in a managed context such as device owner or within a ma
- [Julow/Unexpected-Keyboard](https://github.com/Julow/Unexpected-Keyboard) - A lightweight keyboard for Android
- [ctorney/Daily-Diary](https://github.com/ctorney/Daily-Diary) - Calendar and daily notes app for Onyx Boox.
...
- [shuxueshuxue/PackUp4AI](https://github.com/shuxueshuxue/PackUp4AI) - An Obsidian plugin that helps you manage context for external LLM apps.
...
- [ServiceNowDevProgram/SlackerBot](https://github.com/ServiceNowDevProgram/SlackerBot) - The official application repository for the bot @Slacker on the sndevs.com workspace.
- [AIFanatic/three-nanite](https://github.com/AIFanatic/three-nanite) - An attempt at reproducing unreal nanite in threejs
- [ButterCMS/nextjs-starter-buttercms](https://github.com/ButterCMS/nextjs-starter-buttercms) - Drop-in proof-of-concept Next.js app, fully integrated with your ButterCMS account
...
- [lynxaegon/anysocket](https://github.com/lynxaegon/anysocket) - An abstract networking layer over multiple transports, client/server agnostic with support for E2EE (nodejs/browser)
...
- [thetarnav/force-graph](https://github.com/thetarnav/force-graph) - Force Directed Graph UI
...
- [rbardini/jsonresume-theme-even](https://github.com/rbardini/jsonresume-theme-even) - A flat JSON Resume theme, compatible with the latest resume schema
...
- [Greg-Bush/jsonresume-theme-hr-md](https://github.com/Greg-Bush/jsonresume-theme-hr-md) - JSON Resume Markdown Theme Repository
- [ServiceNowDevProgram/ServiceNow-GenAi-Prompt-Library](https://github.com/ServiceNowDevProgram/ServiceNow-GenAi-Prompt-Library) - Official GitHub repository for the ServiceNow Generative AI Prompt Library
...
- [coveooss/wake-servicenow-instance](https://github.com/coveooss/wake-servicenow-instance) - A command line tool to wake hibernating Servicenow developer instances
- [Isha-Ganar/Coding-Practice-of-JavaScript-for-ServiceNow-Developer](https://github.com/Isha-Ganar/Coding-Practice-of-JavaScript-for-ServiceNow-Developer) - Coding Practice of JavaScript for ServiceNow Developer.
- [unsaved/sn-developer](https://github.com/unsaved/sn-developer) - Development Workstation Utility scripts for ServiceNow Developers
- [Quorafind/Obsidian-Templify](https://github.com/Quorafind/Obsidian-Templify) - A releases repo for custom editable template in Obsidian.
...
- [eallion/mastodon-embed-timeline](https://github.com/eallion/mastodon-embed-timeline) - 🚧🚧🚧🚧🚧Mirror🚧🚧🚧🚧🚧 Mirror of mastodon-embed-timeline. Source: https://gitlab.com/idotj/mastodon-embed-timeline
...
- [ozntel/obsidian-msg-handler](https://github.com/ozntel/obsidian-msg-handler) - 
- [lukemt/obsidian-daily-note-pinner](https://github.com/lukemt/obsidian-daily-note-pinner) - Pins the daily note of the day and unpins other daily notes in Obsidian
- [kormyen/home](https://github.com/kormyen/home) - Portfolio, time tracker and exocortex. No-JS by JS from JS.
- [jacobunknown/Pixelful](https://github.com/jacobunknown/Pixelful) - A minimal, one layer pixel art editor
...
- [thetarnav/streaming-markdown](https://github.com/thetarnav/streaming-markdown) - 🔴Ⓜ️⬇️ Streaming markdown à la ChatGPT (WIP)
- [noclocks/dns](https://github.com/noclocks/dns) - DNS Records Managed via dnscontrol
...
- [Erriez/Clipboarder](https://github.com/Erriez/Clipboarder) - Share clipboard between two computers via USB stick or Cloudstorage
...
- [kando-menu/gnome-shell-integration](https://github.com/kando-menu/gnome-shell-integration) - 🐚 A small GNOME Shell extension required for Kando on Wayland.
...
- [bayramn/QuoteReply-ChatGPT](https://github.com/bayramn/QuoteReply-ChatGPT) - QuoteReply ChatGPT: A Chrome Extension that allows quote reply to ChatGPT
...
- [oto-labs/librarian](https://github.com/oto-labs/librarian) - Better Bookmarks Search w/ Transformers
...
- [pocketnetteam/pocketnet.gui](https://github.com/pocketnetteam/pocketnet.gui) - Decentralized social network based on the blockchain
...
- [jwoglom/mtastatus](https://github.com/jwoglom/mtastatus) - Dashboard which displays MTA New York City Subway train arrival times for a provided set of stations.
- [hshsilver/Scriptable-Widget-MTA-Subway-Train-Reminder](https://github.com/hshsilver/Scriptable-Widget-MTA-Subway-Train-Reminder) - Scriptable Widget MTA Subway Train Reminder. NYC New York City Subway Schedule Panel Widget.
- [ThaddeusJiang/Projectify](https://github.com/ThaddeusJiang/Projectify) - Project management in TiddlyWiki
- [open-spaced-repetition/fsrs4tw](https://github.com/open-spaced-repetition/fsrs4tw) - TiddlyWiki-based memory programme using advanced FSRS algorithm.
...
- [mihakralj/obsidian-textanalysis](https://github.com/mihakralj/obsidian-textanalysis) - Provides real-time text analysis and feedback on readability, structure, and style.
...
- [invernomuto-git/medium-free](https://github.com/invernomuto-git/medium-free) - Medium articles fully readable using Google Cache - Browser Extension
...
- [quadjr/aframe-gaussian-splatting](https://github.com/quadjr/aframe-gaussian-splatting) - A-Frame component implementation of the 3D Gaussian splat viewer
- [webqit/oohtml](https://github.com/webqit/oohtml) - Towards a more dynamic and object-oriented HTML.
- [cjerrington/cjerrington.github.io](https://github.com/cjerrington/cjerrington.github.io) - Source code for my website
...
- [simondevyoutube/Quick_Grass](https://github.com/simondevyoutube/Quick_Grass) - 
- [givanz/VvvebJs](https://github.com/givanz/VvvebJs) - Drag and drop page builder library written in vanilla javascript without dependencies or build tools.
- [leaningtech/webvm](https://github.com/leaningtech/webvm) - Virtual Machine for the Web
- [HudZah/Adblocker](https://github.com/HudZah/Adblocker) - 
...
- [jbaicoianu/janusweb](https://github.com/jbaicoianu/janusweb) - An in-browser implementation of JanusVR
- [devxpy/anti-chatgpt](https://github.com/devxpy/anti-chatgpt) - Antivirus for your mind
- [GiveMeSomething/unmedium-core](https://github.com/GiveMeSomething/unmedium-core) - Read (Medium) articles from Google Cache. Ignore paywall
...
- [sitdownkevin/Blackboard-Enhanced](https://github.com/sitdownkevin/Blackboard-Enhanced) - 四川大学匹兹堡学院 Blackboard 增强插件
...
- [nevinpuri/erlog](https://github.com/nevinpuri/erlog) - Minimalist log collector
...
- [bigansh/tweepsbook](https://github.com/bigansh/tweepsbook) - Discontinued︱What Twitter could not do with Twitter Blue, we did it for free. We allow you to import, organize, take, & share notes on all your “gyan-worthy” bookmarks.
...
- [nature-of-code/Nature-of-Code-Website-Archive](https://github.com/nature-of-code/Nature-of-Code-Website-Archive) - Repo for web files for nature of code
...
- [konstantinruge/gatsby-starter-portfolio-minimal-theme](https://github.com/konstantinruge/gatsby-starter-portfolio-minimal-theme) - A Gatsby Starter Project to get started with the Portfolio Minimal Theme.
...
- [netlify/remix-template](https://github.com/netlify/remix-template) - Deploy your Remix site to Netlify
...
- [lynn/autokalimba](https://github.com/lynn/autokalimba) - a little autoharp for your phone and thumbs!
...
- [codebygina/jekyll-theme-memoirs](https://github.com/codebygina/jekyll-theme-memoirs) - Memoirs is a free minimalist Jekyll theme for those who love the beauty of simplicity.
...
- [rocky-linux/rockylinux.org-gatsby](https://github.com/rocky-linux/rockylinux.org-gatsby) - The official website of the Rocky Linux project.
...
- [crisdosaygo/good.html](https://github.com/crisdosaygo/good.html) - 💎 Good.HTML. A nice framework without the bad stuff. Lots of custom elements, and nice templates. Good. HTML
...
- [jsonblog/jsonblog-cli](https://github.com/jsonblog/jsonblog-cli) - the cli for jsonblog
...
- [DO-SAY-GO/puppetromium](https://github.com/DO-SAY-GO/puppetromium) - :tophat: A single tab web browser built with puppeteer. Also, no client-side JS. Viewport is streamed with MJPEG. For realz.
...
- [NASA-SW-VnV/fret](https://github.com/NASA-SW-VnV/fret) - A framework for the elicitation, specification, formalization and analysis of requirements.
...
- [conceptualspace/yet-another-speed-dial](https://github.com/conceptualspace/yet-another-speed-dial) - a modern, open source speed dial for chrome, edge and firefox
...
- [JinayJain/just-a-minute](https://github.com/JinayJain/just-a-minute) - A web experiment to see how well you can estimate a minute. Compare yourself against 140k+ attempts
...
- [jbee37142/gatsby-starter-bee](https://github.com/jbee37142/gatsby-starter-bee) - 🐝Full Package | Simple | Fresh UI | Blog Template :: Let's start to blogging with gatsby-starter-bee!
- [jbee37142/1st-JBEE.io](https://github.com/jbee37142/1st-JBEE.io) - jbee.io discussions
...
- [saviomartin/gradientking](https://github.com/saviomartin/gradientking) - Never again run out of gradients! 🌈 (discontinued)
...
- [chrisvogt/gatsby-theme-chronogrove](https://github.com/chrisvogt/gatsby-theme-chronogrove) - A homemade GatsbyJS theme for my personal blog and website.
...
- [yvain13/TAPEAgents](https://github.com/yvain13/TAPEAgents) - Showcase capabilities of ServiceNow Tape Agents
...
- [amanovishnu/ineuron-full-stack-data-science-assignments](https://github.com/amanovishnu/ineuron-full-stack-data-science-assignments) - this repository features assignments and projects from the iNeuron full stack data science course, providing valuable resources for learners to enhance their skills and apply their knowledge.
- [jaanli/american-community-survey](https://github.com/jaanli/american-community-survey) - American Community Survey data on people and households
- [Farzy/chatgpt-prompt-eng](https://github.com/Farzy/chatgpt-prompt-eng) - ChatGPT tutorial: Prompt Engineering for Developers
...
- [Ads97/WhatsApp-Llama](https://github.com/Ads97/WhatsApp-Llama) - Finetune a LLM to speak like you based on your WhatsApp Conversations
...
- [a-chris/medium-no-thanks](https://github.com/a-chris/medium-no-thanks) - Workaround to avoid Medium paywall on your Android device.
- [cyb3rko/pincredible](https://github.com/cyb3rko/pincredible) - Modern and secure Android app to help you remember any PIN
...
- [Hujjat/shopify-sunrise](https://github.com/Hujjat/shopify-sunrise) - Shopify Store 2.0 Starter theme with Tailwind CSS & Alpinejs
...
- [igorlfs/dotfiles](https://github.com/igorlfs/dotfiles) - Configs for mostly Neovim and Hyprland
- [cortex-command-community/Cortex-Command-Community-Project-Data](https://github.com/cortex-command-community/Cortex-Command-Community-Project-Data) - [ARCHIVED] The future of Cortex Command
...
- [ephraimduncan/astrosaurus.me](https://github.com/ephraimduncan/astrosaurus.me) - ✨ My personal website and portfolio. Built using Next.js and deployed on Vercel.
...
- [samuelkraft/samuelkraft-next](https://github.com/samuelkraft/samuelkraft-next) - My personal website built with Next.js, Typescript, MDX, Tailwind
...
- [MaggieAppleton/maggieappleton.com-V2](https://github.com/MaggieAppleton/maggieappleton.com-V2) - ⚠️ Now retired. My previous digital garden built with Next.js, React, and MDX. Featuring loosely opinionated notes, half-formed ideas, and content that is always growing.
...
- [LekoArts/portfolio-v2](https://github.com/LekoArts/portfolio-v2) - 
...
- [aarnphm/aarnphm.github.io](https://github.com/aarnphm/aarnphm.github.io) - 
- [zhaoshenzhai/mathwiki](https://github.com/zhaoshenzhai/mathwiki) - A statically-generated site to host my math course notes in university.
...
- [vrienstudios/anime-dl](https://github.com/vrienstudios/anime-dl) - Download anime, novels, manga, and other content for offline consumption.
...
- [ducnguyen96/gorgeos](https://github.com/ducnguyen96/gorgeos) - nixos flake with modular configurations
...
- [kai-tub/hypr-window-switcher](https://github.com/kai-tub/hypr-window-switcher) - A tiny Hyprland script to dmenu-style switch to other windows
...
- [xakpc/anymcp-io](https://github.com/xakpc/anymcp-io) - A catalog of single-file MCP servers for .NET 10
...
- [robur-coop/miragevpn](https://github.com/robur-coop/miragevpn) - An opinionated implementation of the OpenVPN protocol
- [Leonidas-from-XIV/slacko](https://github.com/Leonidas-from-XIV/slacko) - A neat interface for Slack
...
- [Atelier-Shiori/hachidori](https://github.com/Atelier-Shiori/hachidori) - Open Source Kitsu, AniList, and MyAnimeList Scrobbler for macOS
...
- [mskoddow/my_instance_scan_collection](https://github.com/mskoddow/my_instance_scan_collection) - This application contains several hundred hand-picked and completely newly developed instance scan checks for ServiceNow. They focus purely on basic platform and security aspects and are therefore ide
- [insile/OpenText](https://github.com/insile/OpenText) - 一个开放结构化的公共知识库
...
- [Redocly/museum-openapi-example](https://github.com/Redocly/museum-openapi-example) - An example OpenAPI description for an imaginary Museum API.
...
- [sakura8085/awesome-gtm-engineering](https://github.com/sakura8085/awesome-gtm-engineering) - A curated list of tools, libraries, frameworks, and resources for Go-To-Market (GTM) Engineering — the intersection of engineering and marketing, focused on growth, automation, attribution, analytics,
...
- [Naveen-Yeluru/servicenow-itsm-excellence](https://github.com/Naveen-Yeluru/servicenow-itsm-excellence) - Comprehensive implementation of ServiceNow ITSM modules, including MID Server setup, Discovery, integrations, and chatbot development.
...
- [Heydon/principles-of-web-accessibility](https://github.com/Heydon/principles-of-web-accessibility) - How to approach accessible web interface design
...
- [voidashi/obsidian-vault-template](https://github.com/voidashi/obsidian-vault-template) - Simple and efficient template to build your second brain in Obsidian
...
- [ravithemore/Awesome-Twitter-Threads](https://github.com/ravithemore/Awesome-Twitter-Threads) - Awesome Twitter threads by Various Twitter Content Creators on Web Development, Freelancing, Investments, Progarmming, Tech, Devops and Guidance.
- [dkhamsing/open-source-ios-apps](https://github.com/dkhamsing/open-source-ios-apps) - :iphone: Collaborative List of Open-Source iOS Apps
- [stormyark/Obsidian-Vault](https://github.com/stormyark/Obsidian-Vault) - A Template for my Obsidian Vault.
- [brexhq/prompt-engineering](https://github.com/brexhq/prompt-engineering) - Tips and tricks for working with Large Language Models like OpenAI's GPT-4.
- [jmahr07/obsidian](https://github.com/jmahr07/obsidian) - Templates and things from my obsidian vault.
- [sirredbeard/awesome-wsl](https://github.com/sirredbeard/awesome-wsl) - Awesome list dedicated to Windows Subsystem for Linux
- [ollama-webui/ollama-modelfiles](https://github.com/ollama-webui/ollama-modelfiles) - Ollama Modelfiles - Discover more at OllamaHub
- [kylburns89/sn-togetherai-tools](https://github.com/kylburns89/sn-togetherai-tools) - An easily configurable collection of generative AI tools for ServiceNow that utilizes Together.AI's serverless endpoints for GenAI tasks.
- [ServiceNowDevProgram/Plants](https://github.com/ServiceNowDevProgram/Plants) - 🌱
- [ServiceNowDevProgram/example-instancescan-checks](https://github.com/ServiceNowDevProgram/example-instancescan-checks) - 
- [wa3dbk/ScribeSalad](https://github.com/wa3dbk/ScribeSalad) - A collection of YouTube videos transcripts : Podcasts (Joe Rogan Experience, Tim Ferris, Jocko podcast, ..), lectures (YaleCourses, MIT lectures, ..). A big transcripts salad spanning history, geograp
- [iar42/servicenow-pdi-setup](https://github.com/iar42/servicenow-pdi-setup) - This repository contains a Batch Update Set containing some settings and additional tools that assist in quickly preparing a freshly deployed ServiceNow Personal Developer Instance (PDI).
- [erikjanderson/Developer-Operations](https://github.com/erikjanderson/Developer-Operations) - ServiceNow Modal UI to execute custom logic with inputs and outputs
- [pradiptak29/ServiceNow_OpenAI_Integration](https://github.com/pradiptak29/ServiceNow_OpenAI_Integration) - This application is created to integrate ServiceNow with ChatGPT in my personal developer instance.
- [saschawildgrube/servicenow-devtools](https://github.com/saschawildgrube/servicenow-devtools) - Code library and tools for ServiceNow developers
...
- [jassics/cybersecurity-roadmap](https://github.com/jassics/cybersecurity-roadmap) - Skills and career roadmap for various security roles like application security, cloud security, DevSecOps, security engineer, security researchers, pentesting, api security, network security, mobile s
...
- [TwiFucker/Hachidori_assets](https://github.com/TwiFucker/Hachidori_assets) - 
...
- [ReVanced-Extended-Community/Community-Guides](https://github.com/ReVanced-Extended-Community/Community-Guides) - Collection of useful guides related to ReVanced Extended
- [levelsio/awesome-remote-job](https://github.com/levelsio/awesome-remote-job) - A curated list of awesome remote jobs and resources. Inspired by https://github.com/vinta/awesome-python
- [SapphicFire/sn-sidebar-tools](https://github.com/SapphicFire/sn-sidebar-tools) - A repository for several update sets around extending the Sidebar application in the Now platform
- [ironmansoftware/awesome-powershell-universal](https://github.com/ironmansoftware/awesome-powershell-universal) - A curated list of awesome PowerShell Universal resources.
...
- [shure-dev/Awesome-LLM-Papers-Comprehensive-Topics](https://github.com/shure-dev/Awesome-LLM-Papers-Comprehensive-Topics) - Awesome LLM Papers and repos on very comprehensive topics.
...
- [milahu/theyliedabout](https://github.com/milahu/theyliedabout) - lies, scandals, scams, corruption, intelligence tests, psychowar, infowar, exploits, social engineering, ...
...
- [ShahriarKh/obsidian-canvas-snippets](https://github.com/ShahriarKh/obsidian-canvas-snippets) - Useful snippets for Obsidian Canvas
- [YJPL/lean-canvas-for-obsidian](https://github.com/YJPL/lean-canvas-for-obsidian) - 💎 Lean Canvas template for Obsidian
- [iainc/Markdown-Annotations](https://github.com/iainc/Markdown-Annotations) - Markdown Annotations embed authorship in text while preserving its readability and portability.
- [wangligang85/American-Accent-Training-4th-Edition](https://github.com/wangligang85/American-Accent-Training-4th-Edition) - 
- [dkarter/Nietzche-Ipsum-TextExpander](https://github.com/dkarter/Nietzche-Ipsum-TextExpander) - 📖 Nietzche Ipsum for TextExpander
- [Jfaler/Philosophy](https://github.com/Jfaler/Philosophy) - :octocat: A list of philosophy books and resources.
- [iKarwan/iNKillerPlus](https://github.com/iKarwan/iNKillerPlus) - a whole new Instagram Experience
- [MiRO92/uYou-for-YouTube](https://github.com/MiRO92/uYou-for-YouTube) - Enhance Your YouTube Experience
- [nakst/ui-museum](https://github.com/nakst/ui-museum) - Screenshots of user interface elements from various operating systems.
- [cognitom/OpenCola](https://github.com/cognitom/OpenCola) - Coca-Cola
- [g1sbi/qaz-cyberdeck](https://github.com/g1sbi/qaz-cyberdeck) - A cyberdeck featuring a QAZ keyboard and Banana Pi M2 Zero
...
- [jnny/cooking](https://github.com/jnny/cooking) - stashing best recipes as they improve, fermentation log, essential inventory etc
...
- [Coordinate-Cat/Coordinate-Cat](https://github.com/Coordinate-Cat/Coordinate-Cat) - Please don't fork it. using lowlighter/metrics to retrieve and display information from github.  Check the information in the tool author repository or raw.
...
- [mustafah15/zettelkasten](https://github.com/mustafah15/zettelkasten) - my technical notes mostly about software architecture, backend engineering and some more random stuff
...
- [benjypng/alfredworkflow-logseq-quicknote](https://github.com/benjypng/alfredworkflow-logseq-quicknote) - alfredworkflow-logseq-quicknote
...
- [dclstn/better-chat](https://github.com/dclstn/better-chat) - 
...
- [sneakerhax/Arsenal](https://github.com/sneakerhax/Arsenal) - Red Team tools, infrastructure, and hardware weaponized
...
- [karun-karthik/dsa-notes](https://github.com/karun-karthik/dsa-notes) - This repo contains the notes of different data structures and important questions which would help in acing interview rounds.
...
- [bachgarash/flexbox-101](https://github.com/bachgarash/flexbox-101) - Everything you need to know about CSS flexbox
...
- [unixorn/sysadmin-reading-list](https://github.com/unixorn/sysadmin-reading-list) - A reading and viewing list for larval stage SREs and sysadmins
...
- [JoeyMckenzie/openbrewerydb-php-client](https://github.com/JoeyMckenzie/openbrewerydb-php-client) - 🍺 An Open Brewery DB API client for PHP.
- [FreshRSS/FreshRSS](https://github.com/FreshRSS/FreshRSS) - A free, self-hostable news aggregator…
- [opnsense/plugins](https://github.com/opnsense/plugins) - OPNsense plugin collection
- [jxxe/payback](https://github.com/jxxe/payback) - Simple expense tracking for students
...
- [PierceLBrooks/qurantology](https://github.com/PierceLBrooks/qurantology) - https://corpus.quran.com/ontology.jsp
- [seelenbrecher/islamic-agent](https://github.com/seelenbrecher/islamic-agent) - 
...
- [cpfair/quran-tajweed](https://github.com/cpfair/quran-tajweed) - Tajweed annotation for the Qur'an
...
- [Garulf/Obsidian-Notes](https://github.com/Garulf/Obsidian-Notes) - Search Obsidian notes
- [alexta69/metube](https://github.com/alexta69/metube) - Self-hosted YouTube downloader (web UI for youtube-dl / yt-dlp)
- [Unstructured-IO/danswer](https://github.com/Unstructured-IO/danswer) - Gen-AI Chat for Teams - Think ChatGPT if it had access to your team's unique knowledge.
...
- [chasebank87/fabric-connector](https://github.com/chasebank87/fabric-connector) - Provides an API to the Fabric, and its helper tools
...
- [Xancoding/workouts_page](https://github.com/Xancoding/workouts_page) - Make your own workouts page
- [fplanque/obsigo](https://github.com/fplanque/obsigo) - A bridge from Obsidian to Hugo for Static Website Generation (including ForeverLinks redirect support for Netlify).
- [lawwu/transcripts](https://github.com/lawwu/transcripts) - Transcripts for various Youtube Channels inspired by https://karpathy.ai/lexicap/index.html
- [jingkeke/action-transcription](https://github.com/jingkeke/action-transcription) - https://simonwillison.net/2022/Sep/30/action-transcription/   用于捕捉在线视频的字幕和转录。这是一款开源智能工具，可以自动将视频中的音频转换为文字，并提供多语言翻译。  Key takeaways: 1. Action Transcription是一个使用OpenAI Whisper和GitHub Actions构建的工具，可以捕捉在线
- [dangkychua/servicenow-pdi-wakeup](https://github.com/dangkychua/servicenow-pdi-wakeup) - Kick ServiceNow's ass to wake up PDI 24/7
- [ActivityWatch/activitywatch](https://github.com/ActivityWatch/activitywatch) - The best free and open-source automated time tracker. Cross-platform, extensible, privacy-focused.
- [kach/memo](https://github.com/kach/memo) - A probabilistic programming language for metacognitive modeling
...
- [sidmani/tsurara](https://github.com/sidmani/tsurara) - 
...
- [brumik/ollama-obsidian-indexer](https://github.com/brumik/ollama-obsidian-indexer) - ollama-obsidian-indexer
...
- [fargonauts/copycat](https://github.com/fargonauts/copycat) - Modern port of Melanie Mitchell's and Douglas Hofstadter's Copycat
...
- [pmerolla/watch-life](https://github.com/pmerolla/watch-life) - 
- [mkjt2/lockbox](https://github.com/mkjt2/lockbox) - Lockbox is a forward proxy for making third party API calls.
- [codeofdusk/gptcmd](https://github.com/codeofdusk/gptcmd) - Command line large language model conversation and experimentation environment
...
- [twosigma/ngrid](https://github.com/twosigma/ngrid) - It's "less" for data!
...
- [rogeriochaves/driver](https://github.com/rogeriochaves/driver) - 
...
- [dadukhankevin/Finch](https://github.com/dadukhankevin/Finch) - 🐤The next evolution of evolution.
- [harmtemolder/koreader-calibre-plugin](https://github.com/harmtemolder/koreader-calibre-plugin) - A calibre plugin to synchronize metadata from KOReader to calibre
...
- [skorokithakis/sysaidmin](https://github.com/skorokithakis/sysaidmin) - A GPT-powered sysadmin.
- [isafulf/inbox_cleaner](https://github.com/isafulf/inbox_cleaner) - A python script to help manage a Gmail inbox by filtering out promotional emails using GPT-3 or GPT-4.
- [SumanthRH/tokenization](https://github.com/SumanthRH/tokenization) - A comprehensive deep dive into the world of tokens
- [Saghetti0/obsidian-publish-downloader](https://github.com/Saghetti0/obsidian-publish-downloader) - A simple Python script to download an entire Obsidian Publish site
- [TheDuckAI/DuckTrack](https://github.com/TheDuckAI/DuckTrack) - Multimodal computer agent data collection program
...
- [katanaml/llm-mistral-invoice-cpu](https://github.com/katanaml/llm-mistral-invoice-cpu) - Data extraction with LLM on CPU
...
- [sanjacob/BlackboardSync](https://github.com/sanjacob/BlackboardSync) - Download your Blackboard Learn content automatically
...
- [ZeroIntensity/view.py](https://github.com/ZeroIntensity/view.py) - The Batteries-Detachable Web Framework
...
- [mirkolenz/makejinja](https://github.com/mirkolenz/makejinja) - Generate entire directory structures using Jinja templates with support for external data and custom plugins.
...
- [gerardbm/atomic](https://github.com/gerardbm/atomic) - A perceptually balanced color scheme for code editors and terminals. It was designed using HSLuv and ΔE00 to ensure harmony and contrast across light and dark modes.
...
- [nearbeach/NearBeach](https://github.com/nearbeach/NearBeach) - NearBeach is an open sourced project management tool, helping you keep track of your project. You can track requirements, projects and tasks
...
- [mattbillenstein/salty](https://github.com/mattbillenstein/salty) - Simple Saltstack-like deployment system in 2k lines of Python
...
- [tidalcycles/vortex](https://github.com/tidalcycles/vortex) - Moved to https://codeberg.org/uzu/vortex/
...
- [xdevplatform/FactualCat-Twitter-Bot](https://github.com/xdevplatform/FactualCat-Twitter-Bot) - A Twitter bot example using the v2 manage Tweets functionality
...
- [bmulaw/Tweetify](https://github.com/bmulaw/Tweetify) - Like a song on Spotify and this bot will tweet that on your account
...
- [iBug/This-Repo-Has-625-Stars](https://github.com/iBug/This-Repo-Has-625-Stars) - Yes, it's true :gift_heart: This repository has 625 stars.
...
- [flabbergastedbd/awesome-dots](https://github.com/flabbergastedbd/awesome-dots) - All configuration files for my awesome setup
...
- [Yutix/instabrute](https://github.com/Yutix/instabrute) - Multi Brute Force Instagram With Auto Password
...
- [melissavanbussel/quarto-cv-template](https://github.com/melissavanbussel/quarto-cv-template) - 
- [melissavanbussel/spotify-dashboard](https://github.com/melissavanbussel/spotify-dashboard) - This repository contains my entry for the Posit 2024 Table Contest.
- [matt-dray/badgr](https://github.com/matt-dray/badgr) - :shield::sparkles: R package: generate URLs for shields.io metadata badges
...
- [blahblahblah-/subwaynow-server](https://github.com/blahblahblah-/subwaynow-server) - Backend server for Subway Now and frontend for Subway Now lite
- [tj/terminal-table](https://github.com/tj/terminal-table) - Ruby ASCII Table Generator, simple and feature rich.
- [basecamp/kamal-skiff](https://github.com/basecamp/kamal-skiff) - Deploy static sites using nginx + SSI with Kamal
...
- [b1rger/carl](https://github.com/b1rger/carl) - carl is a calendar for the commandline. It tries to mimic the various cal(1) implementations out there, but also adds enhanced features like colors and ical support.
- [RedddFoxxyy/rhyolite](https://github.com/RedddFoxxyy/rhyolite) - A simple markdown editor and knowledge base written in Rust that is compatible with various markdown syntax.
- [TabbyML/tabby](https://github.com/TabbyML/tabby) - Self-hosted AI coding assistant
- [osa1/tiny](https://github.com/osa1/tiny) - A terminal IRC client
- [squidowl/halloy](https://github.com/squidowl/halloy) - IRC application written in Rust
- [glzr-io/zebar](https://github.com/glzr-io/zebar) - Zebar is a tool for creating customizable and cross-platform taskbars, desktop widgets, and popups.
- [cosmic-utils/clipboard-manager](https://github.com/cosmic-utils/clipboard-manager) - Clipboard manager for COSMIC™
...
- [elijahimmer/bar-rs](https://github.com/elijahimmer/bar-rs) - A GTK4 status bar made in rust for my desktop
...
- [ShaddyDC/highlight-extract](https://github.com/ShaddyDC/highlight-extract) - Tool to extract highlights and notes taken on an Onyx Boox e-reader and to export them as Markdown
...
- [oakbrad/brad.quest](https://github.com/oakbrad/brad.quest) - A digital garden.
...
- [dylan-k/tufte-bootstrap](https://github.com/dylan-k/tufte-bootstrap) - Bootstrap styled like Tufte CSS
...
- [hu3rror/memos-litestream](https://github.com/hu3rror/memos-litestream) - ✍️ Run memos with litestream.
- [mikeroyal/macOS-iOS-iPadOS-Guide](https://github.com/mikeroyal/macOS-iOS-iPadOS-Guide) - macOS/iOS/iPadOS Guide
...
- [mcarvalho1/Simple-NerdFonts-Downloader](https://github.com/mcarvalho1/Simple-NerdFonts-Downloader) - This bash script simplifies the process of downloading and installing Nerd Fonts. The script prompts the user to choose a font and its extension, handles the installation process, and supports differe
...
- [M2rsh/hyprland-dots](https://github.com/M2rsh/hyprland-dots) - Config for hyprland a linux wayland compositor
...
- [SerppJunk/spotify-adblock-linux](https://github.com/SerppJunk/spotify-adblock-linux) - script for installing spotify-adblock for ubuntu and popOS based machines
...
- [lkdm/jrnlsync-sh](https://github.com/lkdm/jrnlsync-sh) - Write jrnl.sh entries on iOS, using your favourite writing app and Siri Shortcuts. Then sync your journal with a bash script. Very simple, easy to install and use, and works well.
...
- [marwan/quranwbw](https://github.com/marwan/quranwbw) - QuranWBW.com is your companion for reading, listening to, and learning the Holy Quran, word by word. With features like word audios, Tajweed colors, and transliteration, you can delve into the Quran w
...
- [Fedia/bbb](https://github.com/Fedia/bbb) - Browser Bot Bookmarklet
- [rajnandan1/kener](https://github.com/rajnandan1/kener) - Stunning status pages, batteries included!
- [CharaChorder/DeviceManager](https://github.com/CharaChorder/DeviceManager) - The device manager and configuration tool for CharaChorder devices.
- [wireadmin/wireadmin](https://github.com/wireadmin/wireadmin) - 🐉 WireGuard VPN Server with an web-based admin UI + TOR
- [b-camphart/timeline-view](https://github.com/b-camphart/timeline-view) - Obsidian plugin for viewing your notes linearly based on a given property
...
- [loke-dev/sveltekit-mdsvex-blog-template](https://github.com/loke-dev/sveltekit-mdsvex-blog-template) - MDsveX blog starter template built with Sveltekit & Tailwind
...
- [jamesrochabrun/Claw](https://github.com/jamesrochabrun/Claw) - macOS app for Claude Code
...
- [pal03377/ClipboardPortal](https://github.com/pal03377/ClipboardPortal) - 
...
- [raphaelsalaja/metallurgy](https://github.com/raphaelsalaja/metallurgy) - A SwiftUI Metal Shaders library.
...
- [brunolemos/simplified-twitter](https://github.com/brunolemos/simplified-twitter) - Remove distractions from the new Twitter/X layout. Extension for Chrome, Firefox, Safari, Edge & More
...
- [jeetsukumaran/obsidian-bearings](https://github.com/jeetsukumaran/obsidian-bearings) - An Obsidian plugin providing dynamically scoped tree views of multidimensional semantic and logcal archictectures of your vault.
- [aarongilly/obsidian-semantic-canvas-plugin](https://github.com/aarongilly/obsidian-semantic-canvas-plugin) - 
...
- [vincepg13/sn-script-console](https://github.com/vincepg13/sn-script-console) - 
...
- [insile/OpenWords](https://github.com/insile/OpenWords) - 用于英语学习中背单词与单词管理的 Obsidian 插件
...
- [software-mansion-labs/private-mind](https://github.com/software-mansion-labs/private-mind) - Your private AI mind. In your pocket. For free.
- [medusajs/medusa](https://github.com/medusajs/medusa) - The world's most flexible commerce platform.
- [Unearthed-App/unearthed-obsidian](https://github.com/Unearthed-App/unearthed-obsidian) - 
...
- [msakowski/obsidian-library-linker](https://github.com/msakowski/obsidian-library-linker) - This Obsidian plugin enhances your note-taking experience by providing seamless integration with JW Library links and Bible references.
- [codex-team/editor.js](https://github.com/codex-team/editor.js) - A block-style editor with clean JSON output
- [adeze/raindrop-mcp](https://github.com/adeze/raindrop-mcp) - Raindrop MCP Server
...
- [lone-cloud/gerbil](https://github.com/lone-cloud/gerbil) - A desktop app for running Large Language Models locally.
...
- [ProfessionalWiki/MediaWiki-MCP-Server](https://github.com/ProfessionalWiki/MediaWiki-MCP-Server) - Model Context Protocol (MCP) Server that interacts with any MediaWiki wiki
...
- [formax68/memoChron](https://github.com/formax68/memoChron) - Calendar integration and note creation with support for public iCalendar URLs.
- [phoinixi/jsonresume-theme-react](https://github.com/phoinixi/jsonresume-theme-react) - Professional resume theme written in React for JSON Resume
...
- [sanity-io/sanity-template-nextjs-clean](https://github.com/sanity-io/sanity-template-nextjs-clean) - A clean Next.js template with a native authoring experience
...
- [GnoxNahte/obsidian-tab-panels](https://github.com/GnoxNahte/obsidian-tab-panels) - Create tab panels to organize content into sections
...
- [lynxaegon/obsidian-anysocket-sync](https://github.com/lynxaegon/obsidian-anysocket-sync) - Securely Synchronize your Vault on a self-hosted server
- [itsonlyjames/obsidian-quick-select](https://github.com/itsonlyjames/obsidian-quick-select) - Quickly select items in any modal using keyboard shortcuts. Supercharge your workflow with fast, efficient item selection in Obsidian modals.
- [mark-when/obsidian-plugin](https://github.com/mark-when/obsidian-plugin) - Markwhen obsidian plugin
- [smikula/obsidian-limelight](https://github.com/smikula/obsidian-limelight) - Spotlight your active pane
...
- [vkostyanetsky/ObsidianFoodiary](https://github.com/vkostyanetsky/ObsidianFoodiary) - Food tracker plugin for Obsidian
...
- [pavloDeshko/obsidian-index-checker](https://github.com/pavloDeshko/obsidian-index-checker) - Repo for Index Checker plugin for Obsidian
...
- [Talal-A/obsidian-immich](https://github.com/Talal-A/obsidian-immich) - 
...
- [lhansford/obsidian-checklist-reset](https://github.com/lhansford/obsidian-checklist-reset) - Add a command to reset the state of any checklists in a document in Obsidian
- [claremacrae/reveal-active-file-button-plugin](https://github.com/claremacrae/reveal-active-file-button-plugin) - Obsidian plugin to add a button to the top of the Obsidian File Explorer, to reveal the active file.
...
- [phibr0/obsidian-macros](https://github.com/phibr0/obsidian-macros) - Group multiple Commands into one Macro.
...
- [paulowe/paulowe-web](https://github.com/paulowe/paulowe-web) - My personal site
- [Erallie/css-inserter](https://github.com/Erallie/css-inserter) - Inserts user-defined css snippets into the selected text.
...
- [chasebank87/mesh-ai](https://github.com/chasebank87/mesh-ai) - 
- [chasebank87/unofficial-fabric-plugin](https://github.com/chasebank87/unofficial-fabric-plugin) - Integrate fabric by danielmiessler/fabric into Obsidian
- [ransurf/live-sync-inline-to-yaml](https://github.com/ransurf/live-sync-inline-to-yaml) - 
...
- [tankh99/learnie-plugin](https://github.com/tankh99/learnie-plugin) - Learnie is an Obsidian plugin that helps to enhance your learning with active recall and spaced repetition.
- [Quorafind/better-fn](https://github.com/Quorafind/better-fn) - Footnote hover preview for Obsidian.md
- [Quorafind/Obsidian-Inline-Pomodoro-Timer](https://github.com/Quorafind/Obsidian-Inline-Pomodoro-Timer) - A tomato timer for Obsidian, works inline
...
- [replit/codemirror-minimap](https://github.com/replit/codemirror-minimap) - Minimap extension for Codemirror 6
- [Quorafind/Obsidian-Note-Minimap](https://github.com/Quorafind/Obsidian-Note-Minimap) - 
...
- [Quorafind/obsidian-lineage](https://github.com/Quorafind/obsidian-lineage) - Gingko-like interface in obsidian
- [captbaritone/webamp](https://github.com/captbaritone/webamp) - Winamp 2 reimplemented for the browser
- [zhouhua/obsidian-sticky-headings](https://github.com/zhouhua/obsidian-sticky-headings) - 
- [karstenpedersen/obsidian-daily-note-navbar](https://github.com/karstenpedersen/obsidian-daily-note-navbar) - Adds a daily note navbar to quickly navigate between sequential daily notes in Obsidian.
- [Ankush-Chander/obsidian-smart-move-text](https://github.com/Ankush-Chander/obsidian-smart-move-text) - Organize text/links in file without a hassle
...
- [vasilcoin002/pinned-notes-plugin-obsidian](https://github.com/vasilcoin002/pinned-notes-plugin-obsidian) - 
...
- [mischavandenburg/zettelkasten](https://github.com/mischavandenburg/zettelkasten) - My public Zettelkasten hosted at https://zettelkasten.mischavandenburg.net.  Rendered by Quartz
- [RyoJerryYu/obsidian-memos-sync](https://github.com/RyoJerryYu/obsidian-memos-sync) - Syncing Memos to Obsidian daily note. Fully compatible with official Daily Notes plugin, Calendar plugin and Periodic Notes plugin.
- [tyrekosi/quartz_gruvbox](https://github.com/tyrekosi/quartz_gruvbox) - 
...
- [palantir/documentalist](https://github.com/palantir/documentalist) - :memo: A sort-of-static site generator optimized for living documentation of software projects
- [palantir/ontology-starter-react-app](https://github.com/palantir/ontology-starter-react-app) - Example starter repo for building React applications on top of a Foundry Ontology
- [Mara-Li/archive-quartz-mara](https://github.com/Mara-Li/archive-quartz-mara) - My laboratory... In french
- [icealtria/obsidian-telegram-inbox](https://github.com/icealtria/obsidian-telegram-inbox) - Receive messages from Telegram bots and add them to Obsidian's daily note.
- [meniam/obsidian-vocabulary-cards](https://github.com/meniam/obsidian-vocabulary-cards) - An easy way to display vocabulary words as flashcards and as a list
...
- [mjsumpter/obsidian-tag-page](https://github.com/mjsumpter/obsidian-tag-page) - An Obsidian plugin to create and manage dedicated Markdown pages for tags, with features to automatically populate and refresh content based on user-defined settings.
- [gregzuro/obsidian-kroki](https://github.com/gregzuro/obsidian-kroki) - 
...
- [maxkrieger/gramstract](https://github.com/maxkrieger/gramstract) - Cell Graphical Abstracts Browser
- [seanrcollings/orion-publish-plugin](https://github.com/seanrcollings/orion-publish-plugin) - 
- [simsapa/simsapa-obsidian](https://github.com/simsapa/simsapa-obsidian) - Simsapa plugin for Obsidian
...
- [xHayden/obsidian-mochi-cards-pro](https://github.com/xHayden/obsidian-mochi-cards-pro) - Create flashcards on Mochi.cards using the API provided by Mochi's Pro subscription in Obsidian.
- [mdx-editor/editor](https://github.com/mdx-editor/editor) - A rich text editor React component for markdown
- [jshph/obsidian-enzyme](https://github.com/jshph/obsidian-enzyme) - Digest your Obsidian notes
...
- [anis-marrouchi/shadxn](https://github.com/anis-marrouchi/shadxn) - A CLI for adding components (extended) to your project.
...
- [DophinL/raycast-extensions](https://github.com/DophinL/raycast-extensions) - Everything you need to extend Raycast.
...
- [gigitux/omnivore-newsletter](https://github.com/gigitux/omnivore-newsletter) - Make your Omnivore read-it contents a newsletter!
...
- [mohamadadithya/calendarify](https://github.com/mohamadadithya/calendarify) - Calendarify is a simple and lightweight Vanilla JavaScript datepicker library.
- [GabAlpha/obsidian-githobs](https://github.com/GabAlpha/obsidian-githobs) - Use Obsidian as Github issue editor! A simple plugin to create Github issues directly from Obsidian with logic taken from Git
- [eatgrass/obsidian-vocab-highlighter](https://github.com/eatgrass/obsidian-vocab-highlighter) - Highlight English words according to the frequency with Obsidian
- [Gorkycreator/obsidian-quick-tagger](https://github.com/Gorkycreator/obsidian-quick-tagger) - Quick tagger for Obsidian.md
- [Jamalam360/obsidian-automatic-tags](https://github.com/Jamalam360/obsidian-automatic-tags) - Add tags to new notes automatically based on their path
...
- [noxonad/obsidian-barcode-generator](https://github.com/noxonad/obsidian-barcode-generator) - A barcode generator for obsidian.
...
- [HananoshikaYomaru/obsidian-custom-save](https://github.com/HananoshikaYomaru/obsidian-custom-save) - add custom save action to your save command
- [saertna/obsidian-gamified-pkm](https://github.com/saertna/obsidian-gamified-pkm) - Obsidian Gamified PKM: Supercharge your knowledge management experience through gamification with this Obsidian plugin.
- [tmayoff/obsidian-meals](https://github.com/tmayoff/obsidian-meals) - A meal plan & recipe manager plugin for Obsidian
...
- [serg-plusplus/meeper](https://github.com/serg-plusplus/meeper) - Meeper 📝 - is your secretary for any in-browser conference.
...
- [elebitzero/openai-react-chat](https://github.com/elebitzero/openai-react-chat) - Chat webapp frontend to OpenAI's API with similar features to ChatGPT. Written in React, TailwindCSS, and Typescript..
- [heristop/gutenku](https://github.com/heristop/gutenku) - 🌸 A Haiku generator using Project Gutenberg and AI 🗻
- [vburzynski/obsidian-task-status](https://github.com/vburzynski/obsidian-task-status) - Quickly change any task status in Obsidian. The searchable modal enables a more dynamic and indiscriminate workflow when you need to change your checkbox markers.
- [vpavlenko/rawl](https://github.com/vpavlenko/rawl) - Harmony as Flags 🇱🇺🇱🇹🇬🇦🇦🇲🇲🇺 Western scores in 12 colors. MIDI files in, piano rolls out. Abolition of standard notation's gatekeeping. Prosthesis for sheet-music-blind people. Syntax highlighting for 
...
- [Pr0dt0s/obsidian-html-server](https://github.com/Pr0dt0s/obsidian-html-server) - Obsidian plugin to serve a vault as an html site.
- [hillis/gpt-4-chat-ui](https://github.com/hillis/gpt-4-chat-ui) - This project is a simple React-based chat interface that uses Next.js and communicates with OpenAI's GPT-4 (or GPT-3.5-turbo) language model to generate responses.
- [deiucanta/chatpad](https://github.com/deiucanta/chatpad) - Not just another ChatGPT user-interface!
- [iq-eq-us/dot-io](https://github.com/iq-eq-us/dot-io) - Dot I/O is a free, open source, web based training tool designed to forever change the way we learn to type.
...
- [seethroughdev/obsidian-recipe-grabber](https://github.com/seethroughdev/obsidian-recipe-grabber) - 
- [ChatGPTNextWeb/NextChat](https://github.com/ChatGPTNextWeb/NextChat) - ✨ Light and Fast AI Assistant. Support: Web | iOS | MacOS | Android |  Linux | Windows
- [phiresky/convolution-demo](https://github.com/phiresky/convolution-demo) - Visualization of convolution on pairs of simple functions
...
- [nguyenvanduocit/quote-share](https://github.com/nguyenvanduocit/quote-share) - Generate beautifull image from Obsidian.
- [zachdoty/BrainPress](https://github.com/zachdoty/BrainPress) - BrainPress is a simple NextJS app to self-publish Obsidian vaults. It supports the new canvas files.
- [aqav/obsidian-canvas-links](https://github.com/aqav/obsidian-canvas-links) - Show the links between "Canvas" and "File"
- [andrewmcgivery/obsidian-canvas-dailynote](https://github.com/andrewmcgivery/obsidian-canvas-dailynote) - A plugin for Obsidian that allows you to add a daily note node to the canvas that will always show todays note.
- [john-sungjin/obsidian-cloud](https://github.com/john-sungjin/obsidian-cloud) - A plugin for Obsidian to make the canvas more useful.
- [Mara-Li/obsidian-enhanced-copy](https://github.com/Mara-Li/obsidian-enhanced-copy) - A obsidian plugin that allows to copy in markdown in reading view or canvas read-only view, creating profile and transform the text during copy.
- [Poaceae1999/obsidian_effortless_canvas](https://github.com/Poaceae1999/obsidian_effortless_canvas) - This is a plugin for obsidian. The Goal of this plugin is making Obsidian canvas easier to edit. (inspired by heptabase)
- [borolgs/enchanted-canvas](https://github.com/borolgs/enchanted-canvas) - The plugin for Obsidian that extends the functionality of the standard canvas-plugin.
...
- [michaellw/Obsidian-Canvas-Style-Menu](https://github.com/michaellw/Obsidian-Canvas-Style-Menu) - Customize canvas styles seamlessly through the canvas menu and support styles extension using CSS snippets.
- [Cutaiar/obsidian-song-links](https://github.com/Cutaiar/obsidian-song-links) - For those that get inspired to write by music, a small plugin connecting Spotify to Obsidian.md
...
- [b-camphart/obsidian-search](https://github.com/b-camphart/obsidian-search) - 
...
- [RyotaUshio/obsidian-quick-preview](https://github.com/RyotaUshio/obsidian-quick-preview) - An Obsidian plugin to quickly preview a suggestion before selecting it in link suggestions & quick switcher.
- [BartoszJarocki/cv](https://github.com/BartoszJarocki/cv) - Print-friendly, minimalist CV page
- [ptournet/obsidian-html-tabs](https://github.com/ptournet/obsidian-html-tabs) - Obsidian plugin allowing the creation and rendering of Tabs and tab panels in your notes.
- [camargomau/notkesto-site](https://github.com/camargomau/notkesto-site) - Notkesto, everything I learn and more. Repository for the site.
- [curdinc/skylar-email](https://github.com/curdinc/skylar-email) - 
- [davidlandry93/obsidian-desk](https://github.com/davidlandry93/obsidian-desk) - A desk for obsidian
...
- [TopTierTools/obsidian-better-plugin-page](https://github.com/TopTierTools/obsidian-better-plugin-page) - Better Plugins Page for Obsidian, add filtering and hiding to the page
- [sunxvming/obsidian-vscode-editor](https://github.com/sunxvming/obsidian-vscode-editor) - Edit Code Files like VSCode in Obsidian.
...
- [HananoshikaYomaru/obsidian-tag-generator](https://github.com/HananoshikaYomaru/obsidian-tag-generator) - Break down nested tags into multiple parent tags
- [HananoshikaYomaru/obsidian-incomplete-files](https://github.com/HananoshikaYomaru/obsidian-incomplete-files) - Rule based incomplete files discovery
...
- [manogna4/obsidian-koncham-workspace](https://github.com/manogna4/obsidian-koncham-workspace) - obsidian workspace enhancement [not maintained]
- [selfire1/goodsidian-plugin](https://github.com/selfire1/goodsidian-plugin) - A Goodreads implementation for Obsidian.
- [Mara-Li/obsidian-metacopy](https://github.com/Mara-Li/obsidian-metacopy) - A simple way to copy a frontmatter key in obsidian, and create an url from it !
- [MrGVSV/obsidian-github-embeds](https://github.com/MrGVSV/obsidian-github-embeds) - Embed GitHub issues, PRs, and code snippets directly in Obsidian
...
- [Edo78/obsidian-koreader-sync](https://github.com/Edo78/obsidian-koreader-sync) - Obsidian.md plugin to sync highlights/notes from koreader
- [umami-software/umami](https://github.com/umami-software/umami) - Umami is a modern, privacy-focused alternative to Google Analytics.
- [tomorrowevening/hermes](https://github.com/tomorrowevening/hermes) - Web Tools
- [antoniotejada/obsidian-google-drive](https://github.com/antoniotejada/obsidian-google-drive) - Obsidian.md Google Drive vault synchronization plugin
- [nyable/obsidian-code-block-enhancer](https://github.com/nyable/obsidian-code-block-enhancer) - Enhance obsidian markdown code block,provides copy button,linenumber,language name tip and so on.
- [Fevol/obsidian-criticmarkup](https://github.com/Fevol/obsidian-criticmarkup) - Suggest edits, add comments, and annotate your notes in Obsidian using CriticMarkup syntax
...
- [RafaelGB/Obsidian-ZettelFlow](https://github.com/RafaelGB/Obsidian-ZettelFlow) - ZettelFlow is a plugin for Obsidian that helps you to create and manage your notes in a Zettelkasten way.
...
- [greater-than/Obsidian-Tracker-Plus](https://github.com/greater-than/Obsidian-Tracker-Plus) - A plugin for Obsidian that tracks and visualizes in your notes. A continuation of the plugin originally developed by @pyrochlore
- [kepano/obsidian-permalink-opener](https://github.com/kepano/obsidian-permalink-opener) - Obsidian plugin to open URLs based on a permalink or slug in the note properties. For use with Jekyll, Hugo, Eleventy, Astro, Obsidian Publish, and other publishing tools.
...
- [MayMeow/obsidian-omglol-statuslog](https://github.com/MayMeow/obsidian-omglol-statuslog) - An obsidian plugin to create statuslog posts right from obsidian notes.
- [jamesmagoo/nostr-writer](https://github.com/jamesmagoo/nostr-writer) - Publish seamlessly from Obsidian to Nostr
- [turulix/obsidian-folder-index](https://github.com/turulix/obsidian-folder-index) - 
- [badass-courses/course-builder](https://github.com/badass-courses/course-builder) - 🍄 platform for building Badass Courses
- [TejasQ/gen-subs](https://github.com/TejasQ/gen-subs) - Generate subtitles for your videos with secure, on-device machine learning models.
- [polyipseity/obsidian-terminal](https://github.com/polyipseity/obsidian-terminal) - Integrate consoles, shells, and terminals.
- [NicoNekoru/obsidan-advanced-table-xt](https://github.com/NicoNekoru/obsidan-advanced-table-xt) - Plugin that adds features to tables in obsidian including merging, vertical headers, and custom css
...
- [1rgs/tokenwiz](https://github.com/1rgs/tokenwiz) - A clone of OpenAI's Tokenizer page for HuggingFace Models
- [silentroach/tweet.md](https://github.com/silentroach/tweet.md) - Render tweet into beautiful markdown
- [meta-quest/immersive-web-emulator](https://github.com/meta-quest/immersive-web-emulator) - Browser extension that emulates Meta Quest devices for WebXR development. Lead: Felix Zhang (fe1ix@meta.com)
...
- [microsoft/rushstack-websites](https://github.com/microsoft/rushstack-websites) - Doc content for the Rush Stack websites.
...
- [Zachatoo/obsidian-canvas-send-to-back](https://github.com/Zachatoo/obsidian-canvas-send-to-back) - Send a card in Obsidian Canvas to be behind all other cards.
- [FBarrca/obsidian-handwritten-notes](https://github.com/FBarrca/obsidian-handwritten-notes) - Obsidian Handwritten Notes Plugin
- [hungify/freedium-extension](https://github.com/hungify/freedium-extension) - An extension allows you to remove the paywall on medium.com with one click.
- [chrisgrieser/grappling-hook](https://github.com/chrisgrieser/grappling-hook) - Obsidian Plugin for blazingly fast file switching. For those who find the Quick Switcher still too slow.
...
- [Scrybbling-together/scrybble](https://github.com/Scrybbling-together/scrybble) - Obsidian sync plugin for scrybble
...
- [kiranvshah/chatgpt-helper](https://github.com/kiranvshah/chatgpt-helper) - A VS Code extension to query OpenAI's ChatGPT from inside the editor
...
- [nuxt-modules/medusa](https://github.com/nuxt-modules/medusa) - 🛍️ Medusa module for Nuxt
...
- [alangrainger/obsidian-image-captions](https://github.com/alangrainger/obsidian-image-captions) - Add captions to images with inline Markdown and link support. The caption format is compatible with the CommonMark spec and other Markdown applications.
...
- [Camplejs/Cample.js](https://github.com/Camplejs/Cample.js) - One of the fastest frameworks without a virtual DOM on the Internet!
...
- [Mara-Li/obsidian-canvas-css-class](https://github.com/Mara-Li/obsidian-canvas-css-class) - A plugin that will add a css class to your canvas & adding to each canvas the path to help personnalization
...
- [sancarn/fork-vscode-vba](https://github.com/sancarn/fork-vscode-vba) - VBA syntax highlighting and snippets for use in VSCode
...
- [alii/website](https://github.com/alii/website) - :trollface: :shipit: :octocat: source for alistair.sh
...
- [Mara-Li/obsidian-group-snippets](https://github.com/Mara-Li/obsidian-group-snippets) - Create folder of snippets to activate them in one click !
...
- [agustinusnathaniel/agustinusnathaniel.com](https://github.com/agustinusnathaniel/agustinusnathaniel.com) - Pre-2025 version of my Personal Site, built with Next.js and Chakra UI.
...
- [alex289/Portfolio](https://github.com/alex289/Portfolio) - My portfolio built with Next.js, Tailwind, Drizzle, and Vercel.
...
- [imadatyatalah/next.js-template](https://github.com/imadatyatalah/next.js-template) - Opinionated Next.js and TailwindCSS template.
- [devacame/netam](https://github.com/devacame/netam) - Blog template using Next.JS | TailwindCSS | Markdown
...
- [ngocle2497/BoilerplateReactNative](https://github.com/ngocle2497/BoilerplateReactNative) - Boilerplate react native with redux toolkit, redux listener, fastlane, reanimated, ...
...
- [taskgenius/taskgenius-plugin](https://github.com/taskgenius/taskgenius-plugin) - Comprehensive task management plugin for Obsidian
...
- [nelsonlaidev/nelsonlai.dev](https://github.com/nelsonlaidev/nelsonlai.dev) - My personal website built with TypeScript, Next.js, and TailwindCSS
...
- [kurone-kito/jsonresume-theme-japanese-cv-style-docx](https://github.com/kurone-kito/jsonresume-theme-japanese-cv-style-docx) - 📄 Generate a Word docx file of Japanese-style resume from JSON Resume; since 2019.9
...
- [rayetzki/film-gallery](https://github.com/rayetzki/film-gallery) - Film gallery portfolio site
- [okisdev/Notion-Blog-React](https://github.com/okisdev/Notion-Blog-React) - A Notion Blog powered by Next.js
- [okisdev/Notion-Photo-React](https://github.com/okisdev/Notion-Photo-React) - A Notion Photo Gallery powered by Next.js
...
- [lee-janice/lee-janice.github.io](https://github.com/lee-janice/lee-janice.github.io) - The repository for my personal website
...
- [richard-better-archive/note-tools](https://github.com/richard-better-archive/note-tools) - A collection of my tools related to notetaking
...
- [bitmaks/gatsby-starter-texblog](https://github.com/bitmaks/gatsby-starter-texblog) - A lightweight Gatsby starter with LaTeX functionality
...
- [storopoli/Bayesian-Statistics](https://github.com/storopoli/Bayesian-Statistics) - Bayesian statistics graduate course
...
- [bursteri/jetstream-shadcn-ts](https://github.com/bursteri/jetstream-shadcn-ts) - 
...
- [lxchapu/arknights](https://github.com/lxchapu/arknights) - Arknights 明日方舟（Vue）
...
- [chromatone/chromatone.center](https://github.com/chromatone/chromatone.center) - Chromatone is a digital garden of visual music theory and a collection of visual music instruments
...
- [ycparak/pkms](https://github.com/ycparak/pkms) - 🎧  Personal site, blog and note taking system
...
To the extent possible under law, [zubayrali](https://github.com/zubayrali) has waived all copyright and related or neighboring rights to this work.
